...
4. Vendor pinned Inter files and only the required Lucide SVGs with licenses.
...
| Icon/font supply chain or bloat | Pin, vendor only selected assets, retain licenses, audit checksums/size. |
